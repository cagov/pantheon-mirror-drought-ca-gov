...
if (false === class_exists('WF_Licensing_LoginLockdown')) {
  class WF_Licensing_LoginLockdown
  {
    public $prefix = '';
    ...
    function init()
    {
      if (is_admin()) {
        ...
        wp_enqueue_script('wf_licensing_loginlockdown', $this->js_folder . 'wf-licensing.js', array(), 1.0, true);
        wp_localize_script('wf_licensing_loginlockdown', 'wf_licensing_' . $this->prefix, $vars);
      }
    } // init
  ...
  } // WF_Licensing_LoginLockdown
} // if WF_Licensing_LoginLockdown

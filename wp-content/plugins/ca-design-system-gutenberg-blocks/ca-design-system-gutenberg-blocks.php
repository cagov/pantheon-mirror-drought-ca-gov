...
// Plugin Constants.
define('CAGOV_DESIGN_SYSTEM_HEADLESS_WORDPRESS__VERSION', '1.1.1');
...
// @TODO Check if CAWeb theme is installed, if so - theme & template logic for that site
...
// include_once CAGOV_DESIGN_SYSTEM_HEADLESS_WORDPRESS__DIR_PATH . '/includes/pantheon-page-resources.php';

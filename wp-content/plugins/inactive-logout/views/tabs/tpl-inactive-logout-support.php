...
<div class="ina-settings-admin-wrap ina-settings-admin-support">
	...
	<?php } else { ?>
        <div class="ina-settings-admin-support-bg">
            ...
            <p>Create a ticket from <a href="https://inactive-logout.com/support/">Support forum</a>. Check <a href="https://inactive-logout.com/changelogs/">site</a> for recent change logs and updates.</p>
        </div>
	<?php } ?>

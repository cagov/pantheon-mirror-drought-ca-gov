...
<div class="ina-settings-admin-wrap">
  <form method="post" class="ina-form" id="ina-settings-form" action="?page=inactive-logout&tab=ina-basic">
    ...
    <div class="submit submit-wrapper">
      <input type="submit" name="submit" id="ina-settings-save" class="button button-primary" data-loading="<?php esc_html_e( 'Saving.. Please wait', 'inactive-logout' ); ?>..." value="<?php esc_html_e( 'Save Changes', 'inactive-logout' ); ?>">
    </div>
  </form>
</div>
<script>
